...
var Absorbers = class {
  ...
  async addAbsorber(options, position) {
    const { AbsorberInstance } = await import("./AbsorberInstance-XKPAF5HS.js"), absorber = new AbsorberInstance(this, this.container, options, position);
...
//# sourceMappingURL=Absorbers-PTNKPSZR.js.map
